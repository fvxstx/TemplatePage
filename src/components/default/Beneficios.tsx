...
const Beneficios = () => {
  return (
    <section className="bg-[#3561fe] text-white h-full flex flex-col items-center md:items-start justify-center pt-9 px-4 md:px-16 w-full">
      <div className="max-w-[500px] md:mt-32">
        <div className="mb-4 w-full max-w-[500px]">
          ...
          <div className="flex flex-col md:flex-row">
            <p className="text-2xl md:text-4xl font-bold">benefícios &nbsp;</p>
      ...
      <div className="md:flex md:gap-3 md:mb-4 md:items-center md:justify-center md:w-full">
      ...
      <div className="md:flex md:gap-3 md:mb-4 md:items-center md:justify-center md:w-full">
        ...
        <ItensDiscount
          text={"Informações em primeira mão das empresas listadas na BOVESPA."}
        />
      </div>
    </section>
  );
